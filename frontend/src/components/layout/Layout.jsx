...
const Layout = ({ children, currentPage, setCurrentPage , setPat, onLogout}) => {
  return (
    <div className="flex h-screen bg-[#0F172A] text-slate-200 font-sans overflow-hidden">
      {/* Pass the state to the Sidebar so it knows what to click */}
      <Sidebar currentPage={currentPage} setCurrentPage={setCurrentPage} setPat={setPat} onLogout={onLogout}/>
